...
import com.epam.ui.pages.AllDashboardsPage;
...
public class AllDashboardsPageSteps extends BaseSteps {
    private final AllDashboardsPage dashboardPage;
    private static final Logger LOGGER = LoggerFactory.getLogger(AllDashboardsPageSteps.class);

    public AllDashboardsPageSteps() {
        this.dashboardPage = new AllDashboardsPage();
    }
    ...
    public void choseProject(String projectName) {
        ...
        waitForElementToBeClickable(dashboardPage.getDriver(), dashboardPage.getMenu().getProjectButton());
    ...
    public void openDashboard(String dashboardName) {
        ...
        scrollToTheElement(dashboardPage.getDriver(), getDashboardNameByIndex(0));
        clickOnTheElement(dashboardPage.getDriver(), getDashboardNameByIndex(0));
    }
}
